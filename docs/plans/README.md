...
| —  | Unified Feedback Entry (ADR-0006) | Phases 1 + 2 + 3 shipped 2026-04-25 (`be25e73..13227d3`). **Next:** Phase 4 (drop legacy `modes:` shim now that ash_feedback audio migrated; drop `open()` alias) + Phase 2b `/report` hardening (F1/F3/F4/F9 — see CHANGELOG deferrals) — neither plan written yet. | [ADR](../decisions/0006-unified-feedback-entry.md) / [spec](../superpowers/specs/2026-04-25-unified-feedback-entry-design.md) / [Phase 1](../superpowers/plans/2026-04-25-unified-entry-phase-1.md) / [Phase 2](../superpowers/plans/2026-04-25-unified-entry-phase-2.md) / [Phase 3](../superpowers/plans/2026-04-25-unified-entry-phase-3.md) |
